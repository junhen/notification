 ...
 */
package xx.database.db.table;

import android.util.Log;

import xx.database.db.utils.ClassUtils;
import xx.database.db.utils.FieldUtils;
...
public class TableInfo {
    ...
    public static TableInfo get(Class<?> clazz) {
        ...
        if (tableInfo == null) {
            // throw new DbException("the class[" + clazz +
            // "]'s table is null");
            Log.d("AndroidRuntime", "the class[" + clazz + "]'s table is null");
        }
    ...
    public static void clearAll() {
    	Log.d("DragonsUtil", "DragonsUtil.jar-->TableInfo-->clearAll");
    	tableInfoMap.clear();
    }
