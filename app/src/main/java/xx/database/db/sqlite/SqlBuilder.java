 ...
 */
package xx.database.db.sqlite;

import android.text.TextUtils;
import android.util.Log;

import xx.database.db.table.Id;
import xx.database.db.table.KeyValue;
import xx.database.db.table.ManyToOne;
import xx.database.db.table.Property;
...
public class SqlBuilder {
    ...
    public static SqlInfo buildDeleteSql(Object entity) {
        ...
        if (idvalue == null) {
            // throw new
            // DbException("getDeleteSQL:"+entity.getClass()+" id value is null");
            Log.d("AndroidRuntime", "getDeleteSQL:" + entity.getClass()
                    + " id value is null");
        }
        StringBuffer strSQL = new StringBuffer(
    ...
    public static SqlInfo buildDeleteSql(Class<?> clazz, Object idValue) {
        ...
        if (null == idValue) {
            ...
            Log.d("AndroidRuntime", "getDeleteSQL:idValue is null");
        }
    ...
    public static SqlInfo getUpdateSqlAsSqlInfo(Object entity) {
        ...
        if (null == idvalue) {// 主键值不能为null，否则不能更新
            ...
            // + "]'s id value is null");
            Log.d("AndroidRuntime", "this entity[" + entity.getClass()
                    + "]'s id value is null");
        }
