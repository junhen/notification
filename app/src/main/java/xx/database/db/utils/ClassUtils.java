...
import xx.database.db.annotation.sqlite.Table;
            ...
            for (Field f : fs) {
                if (!FieldUtils.isTransient(f) && FieldUtils.isOneToMany(f)) {
                    ...
                    if (type instanceof ParameterizedType) {
                        ...
                        // throw new
                        // DbException("getOneToManyList Exception:"+f.getName()+"'s type is null");
                        Log.d("AndroidRuntime", "getOneToManyList Exception:"
