...
import xx.database.db.annotation.sqlite.Id;
import xx.database.db.annotation.sqlite.ManyToOne;
import xx.database.db.annotation.sqlite.OneToMany;
import xx.database.db.annotation.sqlite.Property;
import xx.database.db.annotation.sqlite.Transient;
