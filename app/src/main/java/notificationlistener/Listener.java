...
public class Listener extends NotificationListenerService {
    ...
    public void onNotificationRankingUpdate(RankingMap rankingMap) {
        ...
        Message.obtain(sHandler, MSG_ORDER, new Delta(null, rankingMap)).sendToTarget();
    }

    @Override
    public void onNotificationPosted(StatusBarNotification sbn, RankingMap rankingMap) {
        Log.w(TAG, "onNotificationPosted: " + sbn.getKey());
        Message.obtain(sHandler, MSG_NOTIFY, new Delta(sbn, rankingMap)).sendToTarget();
    }

    @Override
    public void onNotificationRemoved(StatusBarNotification sbn, RankingMap rankingMap) {
        Log.w(TAG, "onNotificationRemoved: " + sbn.getKey());
        Message.obtain(sHandler, MSG_CANCEL, new Delta(sbn, rankingMap)).sendToTarget();
    }
